    ...
    public function handle() {
        ...
        if($this->canUpdateOrder){
            $this->order->update([
                ...
                'on_the_way_status_id' => DeliveryCallBackStatusEnum::ON_THE_WAY
            ]);
            ...
            OrderActivity::create([
                ...
                'order_driver_status' => OrderOnTheWayStatusEnum::STARTED,
                'delivery_platform' => DeliveryClientEnum::getDeliveryPlatform($this->deliveryClient)
            ]);
        }


        $this->order->sendStatusNotification('CollectingOrder');
    }
}
